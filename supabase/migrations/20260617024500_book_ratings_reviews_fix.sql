-- Book ratings and reviews system - Idempotent version
...
DROP FUNCTION IF EXISTS public.get_book_average_rating(UUID);
DROP FUNCTION IF EXISTS public.get_book_rating_count(UUID);

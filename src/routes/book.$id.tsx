...
function BookPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-2 md:pt-8 pb-24 animate-fade-in">
        {/* Back link */}
        <Link 
          to="/" 
          className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground transition mb-4 md:mb-10 group"
        >
          <ArrowLeft className="h-4 w-4 mr-2 transition-transform group-hover:-translate-x-1" /> 
          Back to library
        </Link>
        
        <div className="grid md:grid-cols-[280px_1fr] gap-6 md:gap-10 lg:gap-16">
          {/* Cover */}
        ...
        {/* Reviews Section - At bottom on all devices */}
